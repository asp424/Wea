...
import com.example.weatherable.ui.screens.yandex.cells.CardDetailYan
import com.example.weatherable.ui.cells.CellHeader
import com.example.weatherable.ui.cells.Loading
import com.example.weatherable.ui.screens.gismeteo.cells.Logo
                        ...
                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                            ...
                            (values as InternetResponse.OnSuccess).dataValues.apply {
                                Row(
                                    ...
                                    CardDetailYan(
                                        time = listHour[0],
                                        rain = getString("yan_temp_rain0"),
                                        index = 0, temp = getString("yan_temp_tod0")
                                    )
                                    CardDetailYan(
                                        time = listHour[1],
                                ...
                                Row(
                                    ...
                                    CardDetailYan(
                                        time = listHour[0],
                                        rain = getString("yan_temp_rain_t4"),
                                        index = 0, temp = getString("yan_temp_tom4")
                                    )
                                    CardDetailYan(
                                        time = listHour[1],
                                        rain = getString("yan_temp_rain_t5"),
                                        index = 1, temp = getString("yan_temp_tom5")
                                    )
                                    CardDetailYan(
                                        time = listHour[2],
                                        rain = getString("yan_temp_rain_t6"),
                                        index = 2, temp = getString("yan_temp_tom6")
                                    )
                                    CardDetailYan(
                                        time = listHour[3],
                                        rain = getString("yan_temp_rain_t7"),
                                        index = 3, temp = getString("yan_temp_tom7")
                                    )
                                }
                            }
                        }
